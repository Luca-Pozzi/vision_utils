...
SAVE_DIR = '/home/luca/tiago_public_ws/src/vision_utils/saved' # TODO: receive save dir from launch and create /cloud subfolder if it does not exist
...
if __name__ == '__main__':
    ...
    try:
        pointcloud2_saver = PointCloud2Saver(save_path)
        rospy.spin()
